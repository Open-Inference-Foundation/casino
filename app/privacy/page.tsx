...
export const metadata: Metadata = { title: 'Privacy Policy — Ca$ino' };
        ...
        <div className="prose prose-invert max-w-none space-y-8 text-[var(--color-text-secondary)] leading-relaxed">
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 ml-1">
              ...
              <li><strong className="text-[var(--color-text)]">Vercel</strong> — Ca$ino's frontend is hosted on Vercel.</li>
            </ul>
          </section>
