  ...
  return (
    <>
      <SEO
        ...
        description="Terms of service for Ca$ino Builder. By using Ca$ino, you agree to these terms."
        canonicalUrl="/terms"
      />
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <main>
            ...
            <div className="mt-16 pt-8 border-t border-[var(--color-border)]">
              <Link to="/privacy" className="text-sm text-[var(--color-text-secondary)] hover:text-[var(--color-text)]">
                ← Privacy Policy
              </Link>
            </div>
          </main>
